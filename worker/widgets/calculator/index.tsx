// Copied from Kent C. Dodds' Remix example for reference during development
// This uses remix V3 APIs which are not yet stable, so this is just for reference
import { invariant } from "@epic-web/invariant"
import { connect, createRoot, type Remix } from "@remix-run/dom"
import { type EventDescriptor, events } from "@remix-run/events"
